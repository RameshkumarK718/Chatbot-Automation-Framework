        ...
        for index, row in df.iterrows():
            ...
            if (
                ...
                row_dict["Pass and Failure Reason"] = (
                    "Chatbot response was empty or contained an error."
                )
            ...
            if (
                ...
                reason = (
                    ...
                    f"(>= 70.00%), the response is relevant, "
                ...
                if match_pct < 70.0:
                    ...
                    reason = (
                        "Chatbot response was classified as irrelevant."
                    )
                elif hallucinated:
                    reason = result.get(
                        "reason",
                        "Chatbot response contains hallucinated "
